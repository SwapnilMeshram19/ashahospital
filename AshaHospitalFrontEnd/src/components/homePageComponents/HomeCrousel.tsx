    ...
    >
      ...
      <div className="carousel-inner relative h-[500px] w-full overflow-hidden">
        ...
        <div className="carousel-item relative float-left h-[500px] w-full">
          <img src={Slider2} className="block  w-full" alt="..." />
        </div>
        <div className="carousel-item relative float-left h-[500px] w-full">
          <img src={Slider3} className="block w-full" alt="..." />
        </div>
        <div className="carousel-item relative float-left h-[500px] w-full">
          <img src={Slider4} className="block  w-full" alt="..." />
        </div>
        <div className="carousel-item relative float-left h-[500px] w-full">
          <img src={Slider5} className="block  w-full" alt="..." />
        </div>
      </div>
      <button
