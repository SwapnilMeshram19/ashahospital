...
export const AddSuccess: FC<{ open: boolean; title: string }> = ({
  open,
  title,
}) => {
      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative flex transform flex-col justify-center overflow-hidden rounded-lg bg-white text-center shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm">
                <div className="bg-white px-4 pt-5 pb-4 text-center sm:p-6 sm:pb-4">
                  <div className="justify-center  sm:flex sm:items-center">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <Dialog.Title
                        as="h3"
                        className="items-center justify-center text-lg font-medium leading-6 text-gray-900"
                      >
                        {title}
                      </Dialog.Title>
                    </div>
                ...
                <div className="flex-row-reverse justify-center bg-gray-50 py-5 sm:flex ">
                  <button
                    type="button"
