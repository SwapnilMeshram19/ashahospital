...
export const EmpanelmentCard:FC<propsI> = ({empanelment}) => {
    ...
    return (
    <div className=" overflow-hidden rounded-xl text-center border-2 border-gray-100 shadow-xl">
      {empanelment.empanelmentType == "Government" && (
        <div className="text-bold border-b-2 border-gray-100 py-1 font-bold tracking-widest text-cyan-900">
      ...
      <div className="border-t-2 border-gray-100 p-1 pl-4 text-left text-sm font-bold tracking-wider line-clamp-2 hover:line-clamp-none">
        {empanelment.empanelmentType == "Government"
