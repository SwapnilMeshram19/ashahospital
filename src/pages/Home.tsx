    ...
    <div>
      ...
      <div className="flex justify-center gap-10 mt-10">
        <div className="flex max-w-sm flex-col items-center rounded-lg bg-white p-6 shadow-xl">
          ...
          <button
            type="button"
            className=" inline-block rounded-lg m-3 bg-[#171773] px-6 py-2.5 text-xl font-semibold leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg"
          >
            Book Appointment
          </button>

          <p className="mb-4 text-base text-gray-700 m-2">
